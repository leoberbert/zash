...
<p align="center">
  <a href="https://github.com/leoberbert/zash/releases"><img src="https://img.shields.io/badge/Version-1.9.1-blue.svg" alt="Version"/></a>
  <a href="https://github.com/leoberbert/zash/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-green.svg" alt="License"/></a>
</p>

**Zash** is a modern, intuitive, and innovative terminal built with GTK4 and Adwaita. While it offers advanced features appreciated by developers and system administrators, it also stands out for making the command-line environment more accessible, helping those who are just beginning to learn how to use the terminal. Its simplified session management, built-in file manager, automatic color highlighting for improved readability, and a variety of other features bring convenience to users of all skill levels on any Linux distribution.

## Screenshots

<img width="1526" height="1151" alt="Zash" src="https://github.com/user-attachments/assets/ab92d508-b559-46bb-895c-dad64ea6cfbf" />
...
<img width="1386" height="944" alt="Zash AI Assistant" src="https://github.com/user-attachments/assets/22d329c8-d20f-4714-b30e-e83792ac6154" />

Zash creates a bridge between your shell and Large Language Models (LLMs), offering an **optional** and fully **non-intrusive** AI experience. The assistant only processes the content that **you explicitly select and choose to send**, ensuring full control over your privacy.
...
### 🎨 Smart Context<img width="1386" height="944" alt="Zash colors1" src="https://github.com/user-attachments/assets/1674352a-b1ad-4668-b514-21c41306c58e" />
**Aware Highlighting**
<img width="1386" height="944" alt="Zash colors1" src="https://github.com/user-attachments/assets/ff8fb678-0aac-405a-a2c2-0835511a59db" />

Go beyond basic color schemes. Zash applies **dynamic, real-time highlighting** based on both the *content* and the *command being executed*—**without requiring any configuration in Bash or whatever shell you are using**. All color processing happens directly inside Zash’s interface, which is especially helpful when working on servers, containers, or restricted environments where you cannot modify files like `.bashrc` or `.zshrc`.
...
<img width="1386" height="944" alt="Zash have color2" src="https://github.com/user-attachments/assets/10cc985e-a31f-4d45-bd64-57dfe68a91ef" />

In addition, Zash offers a **complete customization interface**, allowing you to adjust:
<img width="1386" height="944" alt="Zash have color3" src="https://github.com/user-attachments/assets/c42461ac-c8ae-41b7-883f-534ea9b333b8" />

* **Text and background colors**
* **Bold**, *italic*, ***underline***, ~~strikethrough~~
* **Blinking mode** for drawing attention to critical information
<img width="1386" height="944" alt="Zash have color4" src="https://github.com/user-attachments/assets/091e9c39-0958-49ca-8209-6c4c264a0c11" />
...
-   **Remote Editing**: Click to edit remote files (SSH/SFTP) in your favorite local editor. Zash watches the file and automatically uploads changes on save.
...
## Dependencies
To build and run Zash, you will need:
...
```bash
sudo pacman -U zash-*-x86_64.pkg.tar.zst
```
...
1.  Clone the repository:
    ...
    ```bash
    git clone [https://github.com/leoberbert/zash.git](https://github.com/leoberbert/zash.git)
    cd zash
    ```
...
# SSH connection
zash --ssh user@server.example.com

# Execute command and close after completion
zash --close-after-execute -e "ls -la"
```

## Configuration

Configuration files are stored in `~/.config/zash/`:
