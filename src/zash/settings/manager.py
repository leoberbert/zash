...
class SettingsValidator:
    ...
    def __init__(self):
        self.logger = get_logger("zash.settings.validator")
...
class SettingsManager:
    ...
    def __init__(self, settings_file: Optional[Path] = None):
        self.logger = get_logger("zash.settings.manager")
    ...
    def _load_settings_safe(self) -> Dict[str, Any]:
        ...
        try:
            ...
            log_error_with_context(e, "settings loading", "zash.settings")
            return self._defaults.copy()
            ...
            with self._lock:
                try:
                    ...
                    log_error_with_context(
                        e, "async settings saving", "zash.settings"
                    )
                    self._dirty = True
