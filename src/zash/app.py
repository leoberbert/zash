...
class ZashApp(Adw.Application):
    ...
    def __init__(self):
        ...
        self.logger = get_logger("zash.app")
    ...
    def _initialize_subsystems(self) -> bool:
        ...
        try:
            ...
            handle_exception(
                e, "application initialization", "zash.app", reraise=True
            )
            return False
    ...
    def _configure_icon_theme(self) -> None:
        ...
        When 'zash' strategy is selected, icons are loaded directly from
        ...
        try:
            ...
            icons._use_bundled_icons = icon_strategy == "zash"

            self.logger.info(
                f"Icon strategy: {'Zash (bundled SVGs)' if icon_strategy == 'zash' else 'System icons'}"
            )
