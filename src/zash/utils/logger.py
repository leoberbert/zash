...
class LoggerConfig:
    ...
    def __init__(self):
        self.log_dir = Path.home() / ".config" / "zash" / "logs"
        self.log_dir.mkdir(parents=True, exist_ok=True)
        self.main_log_file = self.log_dir / "zash.log"
        self.error_log_file = self.log_dir / "zash_errors.log"
...
def log_app_start():
    ...
    logger = get_logger("zash.startup")
...
def log_app_shutdown():
    ...
    logger = get_logger("zash.shutdown")
...
def log_terminal_event(event_type: str, terminal_name: str, details: str = ""):
    ...
    logger = get_logger("zash.terminal")
...
def log_session_event(event_type: str, item_name: str, details: str = ""):
    ...
    logger = get_logger("zash.sessions")
