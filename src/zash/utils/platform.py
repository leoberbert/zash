...
class PlatformInfo:
    ...
    def __init__(self):
        self.logger = get_logger("zash.platform")
...
class PathManager:
    ...
    def __init__(self, platform_info: PlatformInfo):
        ...
        self.logger = get_logger("zash.platform.paths")
...
def ensure_directory_exists(directory: Union[str, Path], mode: int = 0o755) -> bool:
    ...
    try:
        ...
        logger = get_logger("zash.platform.directory")
