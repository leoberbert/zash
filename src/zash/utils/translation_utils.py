...
if 'APPIMAGE' in os.environ or 'APPDIR' in os.environ:
    ...
    # translation_utils.py is in: usr/share/zash/utils/translation_utils.py
    # We need to get to: usr/share/locale
    script_dir = os.path.dirname(os.path.abspath(__file__))  # usr/share/zash/utils
    app_dir = os.path.dirname(script_dir)                    # usr/share/zash
...
# Configure the translation text domain for zash
gettext.bindtextdomain("zash", locale_dir)
gettext.textdomain("zash")
