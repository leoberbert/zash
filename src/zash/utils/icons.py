...
Usage:
    from zash.utils.icons import icon_button, icon_image

    # These automatically use bundled icons when setting is 'zash'
...
_ICON_PATHS = [
    ...
    str(Path(__file__).parent.parent / "icons"),  # src/zash/icons
]
