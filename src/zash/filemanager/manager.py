...
class FileManager(GObject.Object):
    ...
    def __init__(
        ...
        """
        super().__init__()
        self.logger = get_logger("zash.filemanager.manager")
    ...
    def _open_and_monitor_local_file(
        ...
        if app:
            ...
            app.send_notification(f"zash-file-open-{remote_path}", notification)
    ...
    def _on_save_upload_complete(self, transfer_id, success, message):
        ...
        notification.set_icon(Gio.ThemedIcon.new("utilities-terminal-symbolic"))
        app.send_notification(f"zash-upload-complete-{transfer_id}", notification)
